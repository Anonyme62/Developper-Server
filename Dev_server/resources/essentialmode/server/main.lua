...
AddEventHandler('playerDropped', function()
	if(Users[source])then
		...
		db.updateUser(Users[source].identifier, {money = Users[source].money, dirty_money = Users[source].dirty_money, Users[source].bank}, function()
			Users[source] = nil
		end)
	end
end)
...
commands['info'].cmd = function(source, args, user)
	TriggerClientEvent('chatMessage', source, 'SYSTEM', {255, 0, 0}, "^2[^3EssentialMode^2]^0 Version: ^23.1.0")
